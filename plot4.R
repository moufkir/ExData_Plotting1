...
## prepare the canvas for the four graphs
par(mfrow = c(2, 2))
## First graph
with(df, plot(date.time, Global_active_power, type = "l", col = "black", ylab = "Global Active Power (kilowatts)"))

## Second graph
with(df, plot(date.time, Voltage, type = "l", col = "black", ylab = "Voltage"))
...
## Fourth graph
with(df, plot(date.time, Global_reactive_power, type = "l", col = "black"))
